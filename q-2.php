...
<body>
    ...
    <h2 style="color:black;">
        Do you have a role to play in defending against cyber-attacks?
    </h2>

    <p><font size="5" face="arial" color="black">

            <div id="quiz" style="text-align:center;">
            <button id="trivia-btn" onclick="createCustomAlert('Anyone with Internet access is a potential target of cyber-attacks. As such, if you use the Internet, you have an obligation to do your part to limit the impact of such attacks.');">Yes</button><br>
            <button id="trivia-btn" onclick="createCustomAlert2('Yes you have. Anyone with Internet access is a potential target of cyber-attacks. As such, if you use the Internet, you have an obligation to do your part to limit the impact of such attacks.');">No</button>
            <div id="results"></div>   
            <br><br>
        </font>
        </p>
    ...
    <script>
        ...
        function removeCustomAlert() {
            ...
            var p = sessionStorage.getItem("points") + 5;
