...
<body>
    ...
    <p>
        ...
        <button id="trivia-btn" onclick="right();">4</button><br>
        <button id="trivia-btn" onclick="wrong();">8</button><br>
        <button id="trivia-btn" onclick="wrong();">80</button><br>
        <button id="trivia-btn" onclick="wrong();">14</button><br>
        <div id="results"></div>   
        <br><br>
</p>
