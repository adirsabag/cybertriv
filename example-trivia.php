...
<body>
    ...
    <p>
        ...
        <button id="trivia-btn" onclick="createCustomAlert('2 + 2 is simply 4');">4</button><br>
        <button id="trivia-btn" onclick="createCustomAlert2('Please do your math again!');">8</button>
        <button id="trivia-btn" onclick="createCustomAlert2('Please do your math again!');">80</button><br>
        <button id="trivia-btn" onclick="createCustomAlert2('Please do your math again!');">14</button>
        <div id="results"></div>   
        <br><br>
</p>
    ...
    <script>
        ...
        function removeCustomAlert() {
            ...
            window.location.replace('example-trivia2.php');
        }
        function ful(){
